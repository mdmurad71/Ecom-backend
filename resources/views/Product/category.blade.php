            ...
            axios.get(URL).then(function (response) {
                if(response.status==200){
                    ...
                    $.each(response.data,function (i,item){
                        let tableRow="<tr>" +
                            "<td>"+i+"</td>" +
                            "<td><img style='height: 50px;width: 50px;' src='"+item['cat1_image']+"'></td>" +
                            ...
                            "<a class='dropdown-item deleteItem' data-id="+item['id']+" data-img="+item['cat1_image']+" href='#'>Delete</a>"+
                            "<a class='dropdown-item editCategory' data-id="+item['id']+" href='#'>Edit Category</a>"+
                            "<a class='dropdown-item changeImage' data-id="+item['id']+" data-img="+item['cat1_image']+" href='#'>Change Image</a>"+
                            "</div>" +
                            "</div>" +
                            "</td>" +
                            "</tr>";
